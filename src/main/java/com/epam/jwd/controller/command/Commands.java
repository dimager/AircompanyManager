...
import com.epam.jwd.controller.command.authentication.ShowErrorPageCommand;
...
public enum Commands {
    ...
    SHOW_ADD_USER_TO_BRIGADE_PAGE(ShowAddUserToBrigadePageCommand.getInstance(), Role.MANAGER),
