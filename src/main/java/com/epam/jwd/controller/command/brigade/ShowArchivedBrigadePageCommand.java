...
public class ShowArchivedBrigadePageCommand implements Command {
    private static final Logger logger = LogManager.getLogger(ShowAddEditBrigadePageCommand.class);
    private static final Command INSTANCE = new ShowArchivedBrigadePageCommand();
    private static final String BRIGADE_JSP = "/WEB-INF/jsp/archive_brigades.jsp";
    ...
    private ShowArchivedBrigadePageCommand() {
    }
